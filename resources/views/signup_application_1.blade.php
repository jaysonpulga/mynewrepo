                ...
                <div class="modal-content">
                    ...
                    <div class="modal-desc">
                        <p style="text-align:center !important;">
                            Thank you for your interest in <b>{{ env('APP_NAME') }}!</b> We are an exclusive community of shoppers that provide valuable marketing and product feedback to brands.
                        </p>
                    </div>
                 ...
                 @csrf  
                    ...
                    <div class="row" >
                        <div class="col-sm-12">
                            ...
                            <br>
                            <div id='rcorners1'>
                                <p>NOTE: New members may not be offered products to review until after the new year.</p>
                            </div>
                            -->
                            ...
                            <div class="checkbox" id="acceptform">
                                ...
                                <p style='font-size:24px;'>Please read and accept the terms of our community before you register.</p>
                                ...
                                <div class="checkbox">
                                     <input type="checkbox"  required id="question1" name="question1" class="no-ml" value="1"> 
                                     <label for="question1" class="control-label mll pls">I will consider all invitations to review products including those that I normally do not buy because I understand that my insights (and involvement in the community terms) are valuable to participating brands.</label>
                                </div> 
                                
                                <div class="checkbox">
                                     <input type="checkbox"  required id="question2" name="question2" class="no-ml" value="2"> 
                                     <label for="question2" class="control-label mll pls">I will provide honest and constructive feedback using the online questionnaire so that brands can improve their products and marketing.</label>
                                </div> 
                                
                                <div class="checkbox">
                                     <input type="checkbox"  required id="question3" name="question3" class="no-ml" value="3"> 
                                     <label for="question3" class="control-label mll pls">As part of the review process I may be asked to purchase a product before receiving a reimbursement (like a mystery shopper). I understand that there are no risks involved thanks to refund policies of online stores (eg Amazon, Walmart, Ebay…etc) and safeguards provided by credit card companies.</label>
                                </div> 
                                
                                
                                <div class="checkbox">
                                     <input type="checkbox"  required id="question4" name="question4" class="no-ml" value="4"> 
                                     <label for="question4" class="control-label mll pls">After I have been reimbursed for a purchase I WILL NOT return the product for a refund.</label>
                                </div> 
                                
                                <div class="checkbox">
                                     <input type="checkbox"  required id="question5" name="question5" class="no-ml" value="5"> 
                                     <label for="question5" class="control-label mll pls">I understand that I can be removed from the community at anytime for not abiding by our terms.</label>
                                </div> 
                                
                                <div class="checkbox">
                                     <input type="checkbox"  required id="question6" name="question6" class="no-ml" value="6"> 
                                     <label for="question6" class="control-label mll pls">As a shopper I understand that my opinions are valuable when reviewing products and that I will give my honest feedback.</label>
                                </div> 
                                
                                <div class="checkbox">
                                     <input type="checkbox"  required id="question7" name="question7" class="no-ml" value="7"> 
                                     <label for="question7" class="control-label mll pls">I would love to participate and may be willing to share this with other eligible friends.</label>
                                </div> 
    ...
    //window.location.href="{{asset('/failedregistration')}}"+"?code="+window.code 
      ...
      swal({
				  ...
				  type: 'success',
			       ...
			       //window.location.href = "https://eproducts.site";
